...
public class HomeSwipe extends FragmentActivity implements
...
//			fragment.setArguments(args);
			...
			case 3:
				fragment = new TabMyCards(getSupportFragmentManager());
				break;
			default:
		...
		public CharSequence getPageTitle(int position) {
			switch (position) {
			case 0:
				return getString(R.string.tab_my_account).toUpperCase();
			case 1:
				return getString(R.string.tab_Locker).toUpperCase();
			case 2:
				return getString(R.string.tab_bill_pay).toUpperCase();
			case 3:
				return getString(R.string.tab_my_cards).toUpperCase();
			}
			return null;
		}
	}
