...
public class List14 extends ListActivity {
    ...
    private static class EfficientAdapter extends ArrayAdapter<String> {
        ...
        public EfficientAdapter(Context context, int textViewResourceId) {
            ...
            mIcon1 = BitmapFactory.decodeResource(context.getResources(), R.drawable.icon48x48_2);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                holder.layout = (LinearLayout) convertView.findViewById(R.id.lin_layout);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new EfficientAdapter(this, R.layout.list_item_icon_text);
